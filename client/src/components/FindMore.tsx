            ...
            <div className=" sm:mt-8">
                <div className=" grid grid-cols-1 sm:grid-cols-2 rounded-xl overflow-hidden">
                    <div className=" row-span-1 sm:col-span-1">
                        <img className="w-full aspect-auto object-cover object-center" src="/crouselImage/find.jpg" alt="" />
                    </div>
                    <div className=" row-span-1 sm:col-span-1 bg-darkGreen w-full h-full px-6 py-3 lg:px-16 lg:py-5 flex flex-col gap-4 sm:gap-6 justify-center items-start" >
                        ...
                        <p className=" font-Manrope text-sm sm:text-xs lg:text-base text-white">Embark on a journey of discovery as you lace up your boots and venture into the great outdoors.</p>
                        <button className=" bg-lightGreen px-5 py-2 rounded-full font-Lora text-sm lg:text-xl font-semibold">Find More</button>
                    </div>
                </div>
            </div>
        </div>
