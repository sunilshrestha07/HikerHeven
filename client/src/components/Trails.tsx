        ...
        <div className=" bg-gray-100">
            <div className={paddingSize}>
              <div className=" grid grid-rows-2 sm:grid-cols-2 gap-0 sm:gap-14 py-5 sm:py-16">
                  ...
                  <div className=" row-span-1 order-1 sm:order-2 col-span-1 flex flex-col gap-2 sm:gap-3 xl:gap-6 justify-center">
                    ...
                    <button className="bg-darkGreen px-2 sm:px-6 py-1 sm:py-2 font-Lora text-base lg:text-2xl w-2/6 lg:w-1/3 text-white rounded-full">Sign up</button>
                  </div>
              </div>
            </div>
        </div>
